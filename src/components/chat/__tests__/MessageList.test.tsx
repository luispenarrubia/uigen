...
test("MessageList renders messages with parts", () => {
  ...
  // Should show user-friendly message instead of technical tool name
...
test("MessageList displays user-friendly messages for str_replace_editor create command", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
...
test("MessageList displays user-friendly messages for str_replace_editor str_replace command", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
...
test("MessageList displays user-friendly messages for file_manager rename command", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
...
test("MessageList displays user-friendly messages for file_manager delete command", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
